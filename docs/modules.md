...
- `library` owns global file resources and logical folders. Business modules
  own file associations and integrate deletion usage checks through
  `FileUsageChecker`; they never receive physical storage keys.
