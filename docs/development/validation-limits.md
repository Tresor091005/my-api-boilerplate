...
| Label values | 50 characters | Compact classification labels |
...
| Label groups | 2–50 characters | Machine-readable identifiers |
...
A wildcard rule such as `labels.*.*` validates nested values, not associative
