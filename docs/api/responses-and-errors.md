...
Pour garantir une communication cohérente et prévisible avec les clients de l'API, toutes les réponses JSON sont formatées à l'aide de la classe `App\Http\Responses\ApiResponse`.
