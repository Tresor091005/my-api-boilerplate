...
3. Decision rationale and review traps live beside their owning rules; proposed future changes do not override current constraints.
4. Existing code is supporting evidence, not permission to repeat a known violation.

For conflicts, follow Authority and Navigation in `.agents/CODEBASE_RULES.md`: resolve instruction precedence before requesting a decision, and pause only actions that depend on an unresolved material conflict. Search `.ai/rules` by domain keyword as well as by path because some cross-cutting constraints are easy to miss.
...
| app-modules/*/src/Providers/**, app-modules/*/src/Support/**, app-modules/*/src/Integrations/**, app-modules/*/src/Contracts/**, app-modules/*/src/Registries/**, app-modules/*/src/Pipelines/**, app-modules/*/src/Traits/** | .ai/rules/extension-points.md |
