...
return new class extends Migration
{
    public function up(): void
    {
        ...
        DB::statement('CREATE INDEX IF NOT EXISTS catalog_bundle_items_item_id_index ON catalog_bundle_items (item_id) WHERE deleted_at IS NULL');
        DB::statement('DROP INDEX IF EXISTS catalog_bundle_items_display_unit_code_index');
        DB::statement('CREATE INDEX IF NOT EXISTS catalog_bundle_items_display_unit_code_index ON catalog_bundle_items (display_unit_code) WHERE deleted_at IS NULL');
        ...
        DB::statement('CREATE UNIQUE INDEX IF NOT EXISTS catalog_bundle_items_bundle_item_unique ON catalog_bundle_items (organization_id, bundle_id, item_id) WHERE deleted_at IS NULL');
    }
    ...
    public function down(): void
    {
        ...
        DB::statement('DROP INDEX IF EXISTS catalog_bundle_items_item_id_index');
        DB::statement('DROP INDEX IF EXISTS catalog_bundle_items_display_unit_code_index');
        DB::statement('DROP INDEX IF EXISTS catalog_bundle_items_bundle_item_unique');
        DB::statement('DROP INDEX IF EXISTS catalog_bundle_items_bundle_id_index');
        DB::statement('DROP INDEX IF EXISTS catalog_bundle_items_organization_id_index');
