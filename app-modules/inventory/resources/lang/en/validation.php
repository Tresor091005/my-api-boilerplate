...
return [
    ...
    'in_unit_cost_required'                  => "The unit cost is required for 'in' movements in an 'IN' transaction.",
    'in_currency_code_required'              => "The currency code is required for 'in' movements in an 'IN' transaction.",
    'transfer_in_unit_cost_prohibited'       => "The unit cost is prohibited for 'in' movements in a 'TRANSFER' transaction (it is inherited from the source).",
    ...
    'unit_cost_precision'                    => 'The unit cost for currency :currency_code must have at most :precision decimal places.',
