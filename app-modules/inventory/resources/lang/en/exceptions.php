...
return [
    'organization_resolution_failed'      => 'Unable to resolve the organization for this inventory operation.',
    ...
    'item_has_active_stock'                    => 'Inventory tracking cannot be disabled while item :item_id has active stock.',
    'item_cannot_delete_with_active_stock'     => 'The inventory item :item_id cannot be deleted while active stock remains.',
    'location_cannot_delete_with_active_stock' => 'The inventory location :location_id cannot be deleted while active stock remains.',
    ...
    'reversal_type_not_supported'              => 'Only IN, OUT, and unambiguous TRANSFER transactions can be reversed.',
    'reversal_item_tracking_disabled'          => 'The inventory transaction cannot be reversed because item :item_id has stock tracking disabled.',
    'reversal_inconsistency'                   => 'The inventory transaction cannot be reversed because its persisted data is inconsistent.',
    'reversal_stock_already_used'              => 'The inventory transaction cannot be reversed because stock lot :stock_id from movement :movement_id has already been used. Required: :requested, remaining: :remaining.',
];
